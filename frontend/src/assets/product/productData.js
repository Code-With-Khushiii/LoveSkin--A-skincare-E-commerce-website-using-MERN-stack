...
import apricotData from "./apricot/apricotData";
    ...
    allproduct: [
      {
        id: "ac1",
        name: "Collagen Cream",
        type: "Apricot Collagen",
        price: "28.00",
        image: apricotData.apricot1,
        image2: apricotData.apricot1_hover,
        description: [
          {
            span: "REPLENISH YOUR SKIN’S COLLAGEN LEVELS:",
            p: "Our Apricot Collagen Cream is a daily moisturizer that replenishes your skin’s collagen levels and restores elasticity. It’s the perfect solution for dry, sagging skin.",
          },
          {
            span: "UNLOCKING THE SECRET INGREDIENT FROM JEJU ISLAND:",
            p: "Our cream holds 60% of apricot extract. Apricots are rich in vitamin C, which is known to boost collagen production. The Jeju Island apricots are harvested during the spring season, when they are at their ripest and most nutritious.",
          },
          {
            span: "NOURISHING AND HYDRATING FORMULA:",
            p: "The cream is infused with hydrolyzed collagen, which helps to improve skin elasticity and firmness. It also contains hyaluronic acid, which provides deep hydration and plumps the skin.",
          },
          {
            span: "LIGHTWEIGHT AND NON-GREASY TEXTURE:",
            p: "The cream has a lightweight, non-greasy texture that absorbs quickly into the skin, leaving it feeling soft and smooth without any sticky residue.",
          },
          {
            span: "BETTER TOGETHER:",
            p: "See enhanced results by pairing up with other products in our Apricot Collagen line.",
          },
        ],
      },
      {
        ...
        type: "Apricot Collagen",
        price: "26.00",
        image: apricotData.apricot2,
        image2: apricotData.apricot2_hover,
        description: [
          {
            span: "BOOST YOUR SKIN’S COLLAGEN PRODUCTION:",
            p: "Our Apricot Collagen Serum is a powerful treatment that boosts your skin’s collagen production and improves elasticity. It’s the perfect solution for dry, sagging skin.",
          },
          {
            span: "UNLOCKING THE SECRET INGREDIENT FROM JEJU ISLAND:",
            p: "Our serum holds 70% of apricot extract. Apricots are rich in vitamin C, which is known to boost collagen production. The Jeju Island apricots are harvested during the spring season, when they are at their ripest and most nutritious.",
          },    
          {
            span: "CONCENTRATED FORMULA FOR MAXIMUM RESULTS:",
            p: "The serum is infused with hydrolyzed collagen, which helps to improve skin elasticity and firmness. It also contains niacinamide, which brightens the skin and reduces the appearance of fine lines and wrinkles.",
          },
          {
            span: "LIGHTWEIGHT AND FAST-ABSORBING TEXTURE:",
            p: "The serum has a lightweight, fast-absorbing texture that penetrates deep into the skin, delivering maximum results without any greasy residue.",
          },
          {
            span: "BETTER TOGETHER:",
            p: "See enhanced results by pairing up with other products in our Apricot Collagen line.",
